...
/* BK#if 0 Remove this to enable the content (Delete the last #endif too!)*/
...
/*Color settings*/
#define LV_COLOR_DEPTH      32                    /* BKColor depth: 1/8/16/24*/
...
/* BK#endif Remove this to enable the content*/
